...
//https://webdelphi.ru/2009/08/excel-v-delphi-metody-obekta-worksheet-list/  //tr!!!!
//Работа с регулярными выражениями
//https://streletzcoder.ru/rabota-s-regulyarnyimi-vyirazheniyami-v-delphi/  //tr!!!!
//https://docs.microsoft.com/ru-ru/dotnet/api/system.text.regularexpressions.regex?view=net-5.0
unit CodeNP_Unit;
...
function TmainForm.SetLink : String;
var
  i : Integer;
  spr : String;
begin
...
procedure TmainForm.mnCompareZUClick(Sender: TObject);
var
...
procedure TmainForm.CreateReport(msg : Boolean);
var
  s : String;
  i :Integer;
begin
...
procedure TmainForm.mnCodeFromBaseClick(Sender: TObject);
begin
  AllClick;
end;

procedure TmainForm.Loc_FactorLoader(excelname : String);
var
...
procedure TmainForm.BaseLoader(tablename : String; msg : Boolean);
var
  i, j, k : Integer;
  s, ss, sql : String;
  fds : TFieldDefs;
...
procedure TmainForm.Info(msg : String);
begin
...
function TmainForm.FindYellowRow(var WorkSheet : OleVariant; var YellowRow : Integer): Boolean;
var
  range : OleVariant;
  col : Integer;
begin
...
function TmainForm.CalcModel(filename : string; canshow : Boolean; param : Byte) :  Integer;
var
...
procedure TmainForm.mnModelsClick(Sender: TObject);
var
  i, k, d : Integer;
  path, newfile : String;
  sl : TStringList;
...
procedure TmainForm.mnCodeFromSelectionClick(Sender: TObject);
begin
  Building(1, true);
end;

procedure TmainForm.Building(lavel : Integer; msg : Boolean);
var
  i, k : Integer;
  s, ss, param : String;
begin
...
procedure TmainForm.ReplaceTitle(tab : String);
var
  i, j, k : Integer;
  sl : TStringList;
  s : String;
...
procedure TmainForm.SelectNewDataBase(Sender: TObject);
var
  ini: TMemIniFile;
begin
...
procedure TmainForm.SelectNewSpr(Sender: TObject);
begin
...
procedure TmainForm.CreateTablesList;
var
  i, k : Integer;
begin
  ds.Close;
...
procedure TmainForm.lbTablesKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  i : Integer;
begin
...
procedure TmainForm.lbFieldsKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  i, k : Integer;
...
function TmainForm.ImportDataTAB(msg : Boolean) : Boolean;
var
...
procedure TmainForm.mnParamBuildingsClick(Sender: TObject);
var
...
procedure TmainForm.mnFlats_BuildingsClick(Sender: TObject);
var
...
procedure TmainForm.mnFlats_OrphanClick(Sender: TObject);
begin
  mnFlats_BuildingsClick(Sender);
end;

procedure TmainForm.mnCarParkingSpacesClick(Sender: TObject);
var
...
function TmainForm.OnCreateDecompressStream(const InStream: TStream;
...
procedure TmainForm.ExcelCorrectClick(Sender: TObject);
var
  ZipFile : TZipFile;
...
procedure TmainForm.mnParamsClick(Sender: TObject);
begin
...
procedure TmainForm.LoadRules(var list1, list2 : TStringList);
var
  i : Integer;
  s, ss, id : AnsiString;
  p : PAnsiChar;
...
procedure TmainForm.FreeRules(var list1, list2 : TStringList);
var
  i : Integer;
  p : PAnsiChar;
begin
...
procedure TmainForm.CalcVriXlsx(var exceldata : OleVariant);
var
...
procedure TmainForm.mnCadNumberClick(Sender: TObject);
var
  s, fields : String;
  sl : TStringList;
  i : Integer;
...
procedure TmainForm.mnCheckFloorsClick(Sender: TObject);
var
  sl, spr : TStringList;
  i, id, row, k : Integer;
  sprname, s : String;
...
procedure TmainForm.mnCodeFromFileClick(Sender: TObject);
var
  sl : TStringList;
...
procedure TmainForm.mnCodeFromExcelClick(Sender: TObject);
var
...
{------------------------поиск КН в колонке------------------------------------}
function TmainForm.FindStartRow(var sheet : OleVariant; col : Integer) : Integer;
var
  i, row : Integer;
begin
  Result := 5;
...
//==============================================================================
function TmainForm.LoadDate_KVRI_4(feilename : String; var row2, col2 : Integer; var DataParcels : OleVariant) : Boolean;
var
  ExcelApp, Workbook, WorkSheet, range : OleVariant;
begin
  Result := false;
...
//==============================================================================
procedure TmainForm.mnTelda_KVRI_4Click(Sender: TObject);
var
...
//==============================================================================
procedure TmainForm.mnTelda_KVRI_2026Click(Sender: TObject);
var
  i, k, j, col, row, col2, row2, area, startrow : Integer;
  d : Double;
  listVRI, list1, list2 : TStringList;
...
//==============================================================================
procedure TmainForm.mnTelda_KVRI_4_PlusClick(Sender: TObject);
var
  i, k, j, col, row, col2, row2, area, startrow : Integer;
  d : Double;
  listVRI, list1, list2 : TStringList;
...
//==============================================================================
procedure TmainForm.mnVRIFromBaseClick(Sender: TObject);
begin
...
procedure TmainForm.mnVRIFromFileClick(Sender: TObject);
var
...
procedure TmainForm.mnVRIFromExcelClick(Sender: TObject);
var
  ExcelApp, Workbook, WorkSheet, range : OleVariant;
  data : OleVariant;
  row, col, i : Integer;
...
procedure TmainForm.mnInfoClick(Sender: TObject);
var
  i, k, d : Integer;
  path, newfile : String;
  sl : TStringList;
...
procedure TmainForm.mnQueryClick(Sender: TObject);
begin
  ImportDataTAB(true);
  ds.Close;
end;
{-----------------------составляем строку запрося для выборки------------------}
function TmainForm.SetCommandText : Boolean;
var
  j, k : Integer;
  fields : String;
begin
...
procedure TmainForm.ObjectClick(Sender: TObject);
var
...
procedure TmainForm.mnBuildClick(Sender: TObject);
var
